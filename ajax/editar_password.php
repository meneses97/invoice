...
if (version_compare(PHP_VERSION, '5.3.7', '<')) {
    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['user_id_mod'])){
            ...
            $errors[] = "Campo password vazio";
        } elseif ($_POST['user_password_new3'] !== $_POST['user_password_repeat3']) {
            $errors[] = "As palavras passes não considem";
        }  elseif (
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
				...
				$user_password_hash = password_hash($user_password, PASSWORD_DEFAULT);
                    ...
                    if ($query) {
                        $messages[] = "Password foi modificada com sucesso";
                    } else {
                        $errors[] = "Desculpe, ha problemas com os registos enviados";
                    }
