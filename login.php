...
<head>
  ...
  <title>Invoice | Login</title>
	...
	<link rel="stylesheet" href="libraries/bootstrap.min.css" crossorigin="anonymous">
  <!-- CSS  -->
   <link href="css/login.css" type="text/css" rel="stylesheet" media="screen,projection"/>
</head>
<body>
 <div class="container pull-right">
        <div class="card card-container alert alert-danger" >
			...
			<?php
                ...
                <button type="submit" class="btn btn-lg btn-primary btn-signin" name="login" id="submit">Entrar</button>
            </form><!-- /form -->
