        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 toppad" >
          ...
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title"><i class='glyphicon glyphicon-cog'></i> Configurações</h3>
            </div>
					...
					<div class="row">
  						<div class="col-md-12">
							<div class="form-group">
								<input class='filestyle' data-buttonText="Logo" type="file" name="imagefile"
                                       id="imagefile" onchange="upload_image();">
							</div>
						</div>
                  ...
                  <table class="table table-condensed">
                    <tbody>
					  ...
					  <tr>
                        ...
                        <td>
                            <select class="form-control input-sm" name="impuesto">

                                <?php
                                    for ($i=1; $i<= 50; $i++){
                                        if ($i == 1){
                                            echo '<option value="0">ISENTO</option>';
                                        }
                                        if ($row['impuesto']==$i){
                                        $selected="selected";
                                        } else {
					  ...
					  <tr>
                        <td>Simbolo de Moeda:</td>

                          <td><select class='form-control input-sm' name="moneda" required>
										<?php 
											$sql="select name, symbol from  currencies group by symbol, name order by name ";
                      ...
                      <tr>
                          ...
                          <td><input type="text" class="form-control input-sm" name="conta" value="<?php echo $row["conta"];?>"></td>
                      </tr>

                      <tr>
                          <td>NIB:</td>
                          <td><input type="text" class="form-control input-sm" name="nib" value="<?php echo $row["nib"];?>"></td>
                      </tr>

                      <tr>
                          <td>Nome do Banco:</td>
                          <td><input type="text" class="form-control input-sm" name="banco" value="<?php echo $row["banco"];?>"></td>
                      </tr>

                    <tr>
                        <td>&nbsp;</td>
                        <td>   <div class="text-right"> <button type="submit" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-refresh"></i> Actualizar dados</button>
                        </div>
                        </td>
                    </tr>
