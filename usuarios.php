    ...
    <div class="container">
		...
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-info" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus" ></span> Novo Utilizador</button>
			</div>
			<h4><i class='glyphicon glyphicon-search'></i> Buscar Utilizadores</h4>
		</div>			
